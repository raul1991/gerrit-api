...
local GERRIT_USERNAME="${GERRIT_USERNAME}"
local GERRIT_HTTP_PASSWORD="${GERRIT_HTTP_PASSWORD}"
local BASIC_AUTH="${GERRIT_USERNAME}:${GERRIT_HTTP_PASSWORD}"
local GERRIT_SERVER_HOSTNAME="https://${GERRIT_SERVER_HOSTNAME}/a"
